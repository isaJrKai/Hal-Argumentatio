  ...
  return (
    <div className="h-full flex flex-col bg-bg-base overflow-hidden relative">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 bg-[#050505] relative min-h-0" ref={containerRef}>
          {/* Zoom Controls */}
          ...
          <div className="absolute bottom-0 left-0 right-0 z-20 pointer-events-none flex flex-col p-6 gap-4">
            
            {/* Timeline Scrubber */}
            <div className="w-full max-w-2xl mx-auto bg-black/60 backdrop-blur-md border border-white/10 p-4 rounded-xl pointer-events-auto shadow-2xl">
               <div className="flex items-center justify-between mb-2">
                 <h4 className="text-[10px] font-mono font-bold text-white/70 uppercase flex items-center gap-2">
                   <Clock className="w-3.5 h-3.5" /> Historical Network State
                 </h4>
                 <span className="text-[10px] font-mono text-accent">{timelineScrub}% of Nodes Visible</span>
               </div>
               <input 
                  type="range" 
                  min="5" 
            ...
            <div className="w-full max-w-2xl mx-auto bg-gradient-to-t from-black to-transparent rounded-t-xl p-4 pt-10">
              ...
              <div className="font-mono text-[10px] text-accent/80 space-y-1.5 h-12 overflow-hidden opacity-70">
                {(networkData.nodes || [])
