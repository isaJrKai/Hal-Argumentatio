...
export default function ContractModal({ lead, isOpen, onClose }: ContractModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4 overflow-y-auto">
      <div className="bg-[#0b0e14] border border-border-dim w-full max-w-3xl rounded-md shadow-2xl overflow-hidden my-auto print:border-none print:shadow-none print:m-0 print:w-full print:max-w-none">
        ...
        <div className="bg-bg-raised border-b border-border-dim px-4 py-3 flex items-center justify-between print:hidden">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={handlePrint}
              className="px-2.5 py-1 bg-bg-dark border border-border-dim hover:border-brand/40 text-text-primary text-xs font-mono font-bold rounded-sm flex items-center gap-1.5 transition-colors cursor-pointer"
            >
            ...
            <button
              onClick={onClose}
              className="p-1 hover:bg-bg-dark text-text-dim hover:text-text-primary rounded-sm transition-colors"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
        ...
        <div className="bg-[#080a0f] border-b border-border-dim p-3 print:hidden grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs font-mono">
          <button
            onClick={() => {
            ...
            className={`p-2 rounded-sm border text-left transition-all ${
              servicePackage === 'speed_seo'
                ...
                : 'bg-bg-dark border-border-dim text-text-secondary hover:text-text-primary'
            }`}
          >
            <div className="font-bold">Speed & Search Sprint</div>
            <div className="text-[10px] text-brand">$1,500 setup + $500/mo</div>
          </button>
          ...
          >
            ...
            <div className="text-[10px] text-positive">$2,500 setup + $1,200/mo</div>
          </button>
          ...
          >
            ...
            <div className="text-[10px] text-accent">Editable pricing & terms</div>
          </button>
        </div>

        {/* PRINTABLE AGREEMENT BODY */}
        <div className="p-6 sm:p-8 space-y-6 font-mono text-text-primary text-xs bg-bg-dark print:bg-white print:text-black">
          ...
          <div className="space-y-2">
            ...
            <div className="p-3 bg-bg-subtle border border-border-dim rounded-sm text-[11px] leading-relaxed print:bg-white print:border-gray-400">
              {scopeNotes}
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-3 text-[11px]">
              <div className="p-3 bg-bg-subtle border border-border-dim rounded-sm print:bg-gray-50 print:border-gray-400">
                ...
                <span className="text-base font-bold text-brand print:text-black">${setupFee.toLocaleString()} USD</span>
              ...
              <div className="p-3 bg-bg-subtle border border-border-dim rounded-sm print:bg-gray-50 print:border-gray-400">
                ...
                <span className="text-base font-bold text-positive print:text-black">${monthlyRetainer.toLocaleString()} / mo</span>
